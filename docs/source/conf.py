...
# bikecountprediction documentation build
...
from bikecountprediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "bikecountprediction"
author = "Kedro"
...
htmlhelp_basename = "bikecountpredictiondoc"
...
latex_documents = [
    (
        master_doc,
        "bikecountprediction.tex",
        "bikecountprediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "bikecountprediction",
        "Project bikecountprediction codebase.",
        "Data-Science",
    )
]
